...
class WCEXD_Users_Download {
	...
	public function init() {
		...
		if ( isset( $_POST['wcexd-users'] ) ) {
			...
			if ( isset( $_POST['wcexd-suppliers-nonce'] ) && wp_verify_nonce( sanitize_text_field( wp_unslash( $_POST['wcexd-suppliers-nonce'] ) ), 'wcexd-suppliers-submit' ) ) {
			...
			} elseif ( isset( $_POST['wcexd-clients-nonce'] ) && wp_verify_nonce( sanitize_text_field( wp_unslash( $_POST['wcexd-clients-nonce'] ) ), 'wcexd-clients-submit' ) ) {
	...
	public function prepare_single_user_data( $user ) {
		...
		/* Use the company name if presents */
